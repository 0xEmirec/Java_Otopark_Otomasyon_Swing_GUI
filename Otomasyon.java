...
public class Otomasyon extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sys_parola = "emirec";
        char[] parola = jPasswordField1.getPassword();
        String parola2 = String.valueOf(parola);
        if (parola2.equals(sys_parola)) {
             ana_ekran anaEkran = new ana_ekran();
             anaEkran.setVisible(true);
             jPasswordField1.setText("");
        }else{
            String error_message="Parola Hatalı!";
